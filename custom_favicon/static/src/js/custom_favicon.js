// static/src/js/custom_favicon.js
odoo.define('custom_favicon.custom_favicon', function (require) {
    'use strict';
    ...
    core.action_registry.add('custom_favicon.custom_favicon', CustomFavicon);
});
